...
parseList = [
    ...
    {
        'urls': ['http://www.ip181.com/daili/%s.html' % n for n in range(1, 100)],
        'type': 'xpath',
    ...
    {
        'urls': ['http://www.66ip.cn/%s.html' % n for n in ['index'] + list(range(1, 100))],
        'type': 'xpath',
        'pattern': ".//*[@id='main']/div/div[1]/table/tr[position()>1]",
        'position': {'ip': './td[1]', 'port': './td[2]', 'type': './td[4]', 'protocol': ''}
    },
    {
        'urls': ['http://www.xicidaili.com/%s/%s' % (m, n) for m in ['nn', 'nt', 'wn', 'wt'] for n in range(1, 100)],
        'type': 'xpath',
